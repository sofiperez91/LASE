...
SUBGRAPH_VAL_FILE = f'./{dataset_name}_val_subgraphs.pkl'
DATASET_FILE = f'./{dataset_name}_dataset.pkl'
# MASK_08_FILE = f'./{dataset_name}_mask_ER08.pkl'
# MASK_06_FILE = f'./{dataset_name}_mask_ER06.pkl'
# MASK_04_FILE = f'./{dataset_name}_mask_ER04.pkl'
# MASK_02_FILE = f'./{dataset_name}_mask_ER02.pkl'
...
# Remove self-loops
adj_matrix = to_dense_adj(data_.edge_index, max_num_nodes = num_nodes).squeeze(0)
...
for i in range(1000):
    # print(i)
    sub_edge_index, _, _ = dropout_node(data.edge_index, p=0.20)
...
with open(f'./{dataset_name}_mask_FULL.pkl', 'wb') as f:
    pickle.dump(mask,f)